"""
CALM-RV Training with Proper Model Saving
Saves model in HuggingFace format for robustness evaluation
"""
...
def main():
    ...
    # Filter to ferguson-related data for focused training
    rows = [r for r in rows if r.get('event_id') in ['ferguson', 'charliehebdo', 'sydneysiege', 'ottawashooting']]
    print(f"Filtered to {len(rows)} examples")
