"""
LOEO Framework for DistilBERT (Simplified, without representation extraction)
L_align is disabled because DistilBERT has different architecture
"""
...
def train_and_evaluate(train_rows, test_rows, test_event_name, args, cfg, device):
    ...
    for epoch in range(epochs):
        ...
        for batch in train_loader:
            ...
            # No L_align for DistilBERT (architecture limitation)
...
def main():
    ...
    print("="*60)
    print(f"DISTILBERT LOEO Experiment: {args.exp_name}")
    ...
    print("\n" + "="*60)
    print(f"DISTILBERT RESULTS FOR {args.test_event.upper()}")
    print("="*60)
