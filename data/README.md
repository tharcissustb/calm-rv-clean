...
\- \*\*URL\*\*: https://figshare.com/articles/dataset/PHEME\_dataset\_for\_Rumour\_Detection\_and\_Veracity\_Classification/6392078
...
\- \*\*URL\*\*: https://github.com/thunlp/Chinese\_Rumor\_Dataset
...
\- Run `scripts/generate\_synonym\_aug.py` to create the synonym‑augmented JSONL file.

\- Run `scripts/generate\_hard\_augmented.py` (or the original BART pipeline) to create the BART‑augmented file.
